...
%% 0. —— 配置区 —— 
petDir = 'F:\ADNI数据集902样本\06-PET配准_去头骨_平滑\02PET去头骨';      % 放原始 PET .nii 的文件夹
outDir = 'F:\ADNI数据集902样本\06-PET配准_去头骨_平滑\03PET平滑'; % 平滑结果输出目录
...
for i = 1:numel(petList)
    ...
    matlabbatch{1}.spm.spatial.smooth.fwhm   = [6 6 6];     % 高斯核大小 :contentReference[oaicite:2]{index=2}
